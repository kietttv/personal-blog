<?php
    ...
    $selectNewPosts = "SELECT * FROM `post` ORDER BY DATE(date) DESC ,date ASC LIMIT 3";
...
<?php while($rowPost = mysqli_fetch_assoc($rePosts)){
    ...
    <?php if(isset($_SESSION['user'])){?>  
                ...
                <a class="btn btn-link p-0" href="#?id=<?=$rowPost['id']?>">Delete<i class="fa fa-angle-right"></i></a>
    <?php }?>         
            </div>
        </div>
    </div>
